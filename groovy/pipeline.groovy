    ...
    dir("") {
        ...
        */
        stage("Push Documentation"){
            println callPost("http://192.168.99.100:9123/document", '{"id": "cjkbvajs1234", "name": "ServiceNow", "owner": "Martin","description":"bla bla kjsfnkjsv noch mehr text","short_name":"serviceAZ12345"}') //Include protocol
        }//stage
